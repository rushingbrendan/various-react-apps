      ...
      return (        
        <div>
            <nav className="navbar navbar-expand-md navbar-custom">
                <a style={{ fontWeight: 'bold', fontSize: '18pt' }} className="navbar-brand" href="/">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FontAwesomeIcon icon="eye-dropper" size="2x" /> &nbsp;&nbsp;Baseball Scores&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item active">
                        <a style={{marginTop: '20px', fontSize: '14pt'}} className="nav-link" href="/color"> </a>
                    </li>
                    {/* <li className="nav-item active">
